    ...
    <section class="space-y-6">
                ...
                <div>
                    ...
                    @if ($menuItem->image_path)
                        <div class="mt-4 h-24 w-24 overflow-hidden rounded-2xl border border-line">
                            <img src="{{ asset('storage/' . $menuItem->image_path) }}" alt="{{ $menuItem->name }}" class="h-full w-full object-cover">
                        </div>
                    @endif
                </div>
        ...
        <div class="rounded-[2rem] border border-line bg-white p-6 shadow-panel">
            ...
            <div class="mt-6 flex flex-col gap-3">
                ...
                <a href="{{ route('admin.menu-items.index') }}" class="rounded-2xl border border-line px-5 py-4 text-center text-base font-semibold transition hover:bg-shell">
                    Back to Menu Items
                </a>
            </div>
        </div>
